    ...
    <p class="music-credit" style="margin-top: 20px; font-size: 16px;">
        ...
        <div id="setting" class="py-4 text-light">
            ...
            <p> 
                ...
                <label for="speed5">A Challenge</label><br>
                <input id="speed6" type="radio" name="speed" value="20"/>
                <label for="speed6">NOW THIS! THIS IS REAL FIREPOWER!</label><br>
            </p>
            <p>Wall:
            ...
            <button data-color="rgb(74, 104, 218)"><span style="color:rgb(74, 104, 218)">Original Blue</span></button>
...
<script>
    ...
    alert("Rainbow effect is now enabled! Disable by reloading the page (and, in doing so, resetting the matrix).");
});
</script>
...
// Replace your existing snake button event listeners with this updated version
...
// Place these near the end of your code, where setWall was previously defined
...
// This replaces your existing setWall function
